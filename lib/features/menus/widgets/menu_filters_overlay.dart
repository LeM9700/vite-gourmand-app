                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Text('200€', style: AppTextStyles.caption),
                                            ],
                                          ),
                                        ],
                                      ),
                                          ...
                                          Wrap(
                                            ...
                                            children: widget.availableRegimes.map((regime) {
                                              ...
                                              return ChoiceChip(
                                                ...
                                                onSelected: (selected) {
                                                  setState(() {
                                                    _selectedRegime = selected ? regime : null;
                                                  });
                                                },
                                                backgroundColor: AppColors.glassFill,
                                                selectedColor: AppColors.primary.withOpacity(0.2),
                                        ...
                                        children: [
                                          ...
                                          SliderTheme(
                                            ...
                                            child: Slider(
                                              ...
                                              divisions: 48,
                                              onChanged: (value) {
                                                setState(() => _minPeopleMax = value.toInt());
                                              },
                                            ),
                                          ),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text('2 pers', style: AppTextStyles.caption),
                                              Text('50 pers', style: AppTextStyles.caption),
                                            ],
                                          ),
                                        ],
                                      ),
