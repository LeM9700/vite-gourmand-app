...
class _HomeSectionFooterState extends State<HomeSectionFooter> {
          ...
          isSmallScreen
              ...
              : Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 2,
                      child: _buildLinksSection(context, padding, titleSize, bodySize),
                    ),
                  ],
                ),
  ...
  Widget _buildScheduleSection(BuildContext context, double titleSize, double bodySize) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildLinksSection(BuildContext context, double padding, double titleSize, double bodySize) {
  ...
  List<Widget> _buildScheduleItems(BuildContext context, double fontSize) {
    ...
    return sortedSchedules.map((schedule) {
      ...
      if (isClosed) {
        ...
        final openFormatted = openTime.split(':')[0] + 'h' + (openTime.split(':')[1] != '00' ? openTime.split(':')[1] : '');
        final closeFormatted = closeTime.split(':')[0] + 'h' + (closeTime.split(':')[1] != '00' ? closeTime.split(':')[1] : '');
      ...
      return Padding(
        padding: EdgeInsets.only(bottom: context.fluidValue(minValue: 4, maxValue: 6)),
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            SizedBox(
